...
public class TopicosController {
	...
	public Page<TopicoDto> lista(@RequestParam(required = false) String nomeCurso, @RequestParam int pagina,
			@RequestParam int qtd, @RequestParam String ordencao) {
		Pageable paginacao = PageRequest.of(pagina, qtd, Direction.ASC, ordencao);
		if (nomeCurso == null) {
	...
	public ResponseEntity<TopicoDto> atualizar(@PathVariable Long id, @RequestBody @Valid AtualizacaoTopicoForm form) {
		...
		if (optional.isPresent()) {
			Topico topico = form.converter(id, topicoRepository);
